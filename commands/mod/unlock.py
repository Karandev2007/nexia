    ...
    async def unlock_command(interaction: discord.Interaction):
        ...
        try:
            ...
            embed = discord.Embed(
                ...
                description=f"🔓 The seal on {channel.mention} has been lifted. All may now speak freely.",
            ...
            await interaction.response.send_message("The magic required to unlock this space is beyond my grasp.", ephemeral=True)
