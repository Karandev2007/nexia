    ...
    async def lock_command(interaction: discord.Interaction):
        ...
        try:
            ...
            embed = discord.Embed(
                ...
                description=f"🔒 The gates to {channel.mention} have been sealed. Only the high council may now speak.",
            ...
            await interaction.response.send_message("The magic required to lock this space is beyond my grasp.", ephemeral=True)
